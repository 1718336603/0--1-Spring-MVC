...
//            tomcat.setBaseDir(configuration.getDocBase());
//
////            log.info(configuration.getDocBase());
//
//            tomcat.setPort(configuration.getServerPort());
//
////            log.info(String.valueOf(configuration.getServerPort()));
//
//            //找到编译文件的位置
//            File root = getRootFolder();
//
...
////            log.info(configuration.getResourcePath());
//
//            if (!webContentFolder.exists()) {
//                webContentFolder = Files.createTempDirectory("default-doc-base").toFile();
//            }
...
//            log.info(runningJarPath);
            int lastIndexOf = runningJarPath.lastIndexOf("/target/");
//            log.info(String.valueOf(lastIndexOf));
            if (lastIndexOf < 0) {
                root = new File("");
            } else {
                root = new File(runningJarPath.substring(0, lastIndexOf));
//                log.info(runningJarPath.substring(0, lastIndexOf));
            }
